...
// import {getDepartmentsList} from '../../../../../pages/fee/helpers/helpers';
import {feeReportActionTypes} from '../../../../../pages/fee/redux/feeReports/feeReportsActiontype'
...
export const inputFields = (allStates = {}, allFunctions = {}, styles = {}) => {
  ...
  const {t, getSelectedNodes, handleIsPendingChequeDataIncluded} = allFunctions
  ...
  return [
    ...
    },
    {
      ...
      inputField: {
        type: INSTITUTE_TREE_TYPE,
        hierarchyTypes: [INSTITUTE_HIERARCHY_TYPES.DEPARTMENT],
        value: hierarchyIds,
        expandChildNodesDefault: false,
        expandTill: INSTITUTE_HIERARCHY_TYPES.DEPARTMENT,
        onChange: (nodes) => {
