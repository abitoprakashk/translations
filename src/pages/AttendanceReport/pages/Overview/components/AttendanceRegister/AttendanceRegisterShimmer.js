...
function AttendanceRegisterShimmer() {
  return (
    <svg viewBox="0 0 1000 550">
      <rect
        ...
        width="100%"
        height="100%"
        clipPath="url(#clip-path-id-AttendanceRegisterShimmer)"
        style={{fill: 'url(#animated-diff)'}}
      />
      <defs role="presentation">
        <clipPath id="clip-path-id-AttendanceRegisterShimmer">
...
export default AttendanceRegisterShimmer
