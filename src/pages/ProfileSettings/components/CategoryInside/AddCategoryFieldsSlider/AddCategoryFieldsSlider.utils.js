import {FIELD_TYPES_OBJECT} from '../../../ProfileSettings.constant'
...
export const getRequestParamsObject = ({
  ...
  const requestPrams = {
    ...
    field_type: addNewFieldFormInputsValue?.fieldTypeName,
    char_limit: addNewFieldFormInputsValue?.charLimit,
    setting_type: 2,
    date_range:
      addNewFieldFormInputsValue.dateRange.length > 0
        ? addNewFieldFormInputsValue.dateRange
        : [],
    permissible_values:
...
export const dropDownOptionItemsState = [
  {dropDownOptionName: ''},
  {dropDownOptionName: ''},
]
