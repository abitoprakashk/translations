...
import AddDocumentCategoryFieldSlider from '../AddDocumentCategoryFieldSlider/AddDocumentCategoryFieldSlider'
import DocumentCategoryFieldsPreviewSlider from '../DocumentCategoryFieldsPreviewSlider/DocumentCategoryFieldsPreviewSlider'
import Permission from '../../../../../components/Common/Permission/Permission'
import {PERMISSION_CONSTANTS} from '../../../../../utils/permission.constants'
import {events} from '../../../../../utils/EventsConstants'
import styles from './DocumentCategoryHeaderSection.module.css'

const DocumentCategoryHeaderSection = ({categoryFieldsDetails, userType}) => {
  ...
  // Add document field slider functions start
  const openAddFieldSlider = () => {
    setAddFieldSlider(true)
    setDataResetFlag(false)
    eventManager.send_event(events.ADD_NEW_PROFILE_DOCUMENTS_CLICKED_TFI, {
      screen_name: userType,
      category_id: categoryFieldsDetails?._id,
    })
  }
  ...
  const closeConfirmObject = {
    ...
    confirmationTitle: t('closeAddDocumentFieldSliderPopupTitle'),
    confirmationDesc: t('closeAddDocumentFieldSliderPopupDesc'),
  }
  // Add document field slider functions end
  ...
  return (
    <div className={styles.headerInnerSection}>
      ...
      {/* Add Field Slider */}
      {showAddFieldSlider && (
        <AddDocumentCategoryFieldSlider
          userType={userType}
      ...
      {showFieldsPreviewSlider && (
        <DocumentCategoryFieldsPreviewSlider
          persona={userType}
...
export default DocumentCategoryHeaderSection
